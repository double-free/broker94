...
_OesStkQrySample_PrintClientOverview(OesClientOverviewT *pClientOverview) {
    ...
    printf(">>> Client Overview: { clientId[%d], " \
            ...
            "qryTrafficLimit[%d], maxOrdCount[%d], associatedCustCnt[%d] }\n",
...
_OesStkQrySample_PrintInvAcctItem(OesInvAcctItemT *pInvAcctItem) {
    ...
    printf(">>> InvAcct Item: { " \
            ...
            "pbuId[0%d], stkPositionLimitRatio[%d], "
            "subscriptionQuota[%d], kcSubscriptionQuota[%d] }\n",
            ...
            pInvAcctItem->pbuId, pInvAcctItem->stkPositionLimitRatio,
            pInvAcctItem->subscriptionQuota, pInvAcctItem->kcSubscriptionQuota);
}
...
_OesStkQrySample_PrintFundTrsfItem(OesFundTransferSerialItemT *pFundTrsfItem) {
    ...
    printf(">>> Fund transfer serial Item: { " \
            ...
            pFundTrsfItem->isAllotOnly, pFundTrsfItem->trsfStatus,
...
_OesStkQrySample_OnQryMsgCallback(OesApiSessionInfoT *pSessionInfo,
    ...
    case OESMSG_QRYMSG_ORD: {
        ...
        _OesStkQrySample_PrintOrderItem((OesOrdItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_TRD: {
        ...
        _OesStkQrySample_PrintTradeItem((OesTrdItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_CASH_ASSET: {
        ...
        _OesStkQrySample_PrintCashAssetItem((OesCashAssetItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_STOCK: {
        ...
        if (0) {
            char            buf[1024] = {0};
            _OesStkQrySample_FormatStockStatus((OesStockItemT *) pMsgBody, buf,
                    sizeof(buf));
        }

        _OesStkQrySample_PrintStockItem((OesStockItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_STK_HLD: {
        ...
        _OesStkQrySample_PrintStkHoldingItem((OesStkHoldingItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_ISSUE: {
        ...
        _OesStkQrySample_PrintIssueItem((OesIssueItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_LOT_WINNING: {
        ...
        _OesStkQrySample_PrintLotWinningItem((OesLotWinningItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_CUST: {
        ...
        _OesStkQrySample_PrintCustItem((OesCustItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_INV_ACCT: {
        ...
        _OesStkQrySample_PrintInvAcctItem((OesInvAcctItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_COMMISSION_RATE: {
        ...
        _OesStkQrySample_PrintCommissionRateItem((OesCommissionRateItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_FUND_TRSF: {
        ...
        _OesStkQrySample_PrintFundTrsfItem((OesFundTransferSerialItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_ETF: {
        ...
        _OesStkQrySample_PrintEtfItem((OesEtfItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_ETF_COMPONENT: {
        ...
        _OesStkQrySample_PrintEtfComponentItem((OesEtfComponentItemT *) pMsgBody);
        break;
    }
    ...
    case OESMSG_QRYMSG_MARKET_STATE: {
        ...
        _OesStkQrySample_PrintMarketState((OesMarketStateItemT *) pMsgBody);
        break;
    }
